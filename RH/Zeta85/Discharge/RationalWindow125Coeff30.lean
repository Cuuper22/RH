...
-/
import RH.Zeta85.Discharge.RationalWindow125Coeff29
...
theorem centeredCoeffFormula125_60 (u : ℝ) :
    centeredCoeffFormula125 u 60 =
      491713286228147833028265808241289 / 39062500 := by
  ...
  simp only [shiftedBaseCoeff125_eq_zero (by norm_num : 31 ≤ 31),
    ...
    shiftedBaseCoeff125_eq_zero (by norm_num : 31 ≤ 57),
    shiftedBaseCoeff125_eq_zero (by norm_num : 31 ≤ 58),
    shiftedBaseCoeff125_eq_zero (by norm_num : 31 ≤ 59),
    shiftedBaseCoeff125_eq_zero (by norm_num : 31 ≤ 60),
