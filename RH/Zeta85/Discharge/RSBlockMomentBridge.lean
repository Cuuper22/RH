...
theorem quarticTraceLowerBound_of_uncenteredRS
    ...
    (q : Quartic) :
    QuarticTransfer.ZeroTupleQuarticLowerBound q F := by
  ...
  exact
    (QuarticTransfer.weightedQuarticLimit_of_separate hdim hscore).toLowerBound.toTraceLowerBound.toUncentered.toCyclic.toZeroCyclic.toTuple
