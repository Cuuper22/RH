...
theorem quarticTraceLowerBound_of_uncenteredRS
    ...
    (q : Quartic) :
    QuarticTransfer.UncenteredQuarticTraceLowerBound q F := by
  ...
  exact
    (QuarticTransfer.weightedQuarticLimit_of_separate hdim hscore).toLowerBound.toTraceLowerBound.toUncentered
