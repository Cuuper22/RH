...
substitute for the trace, zero-side, or one-sided explicit cyclic-entry bound.
-/
...
theorem rung8657
    ...
    (hweighted : QuarticTransfer.CyclicQuarticLowerBound QuarticTransfer.Terminal8686.dual F) :
...
theorem rung9383
    ...
    (hfull : FullTraceLimits F) (hzero : StableZeroSide F)
    (hweighted : QuarticTransfer.CyclicQuarticLowerBound QuarticTransfer.Terminal9506.dual F) :
