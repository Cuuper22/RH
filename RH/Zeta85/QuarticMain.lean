...
substitute for the trace, zero-side, or one-sided literal zero-correlation bound.
-/
...
theorem rung8657
    ...
    (hweighted : QuarticTransfer.ZeroCyclicQuarticLowerBound QuarticTransfer.Terminal8686.dual F) :
...
theorem rung9383
    ...
    (hfull : FullTraceLimits F) (hzero : StableZeroSide F)
    (hweighted : QuarticTransfer.ZeroCyclicQuarticLowerBound QuarticTransfer.Terminal9506.dual F) :
