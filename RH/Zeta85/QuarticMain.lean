...
substitute for the trace, zero-side, or one-sided expanded zero-tuple bound.
-/
...
theorem rung8657
    ...
    (hweighted : QuarticTransfer.ZeroTupleQuarticLowerBound QuarticTransfer.Terminal8686.dual F) :
...
theorem rung9383
    ...
    (hfull : FullTraceLimits F) (hzero : StableZeroSide F)
    (hweighted : QuarticTransfer.ZeroTupleQuarticLowerBound QuarticTransfer.Terminal9506.dual F) :
