...
theorem rung8657
    ...
    (hweighted : QuarticTransfer.FactoredZeroKernelQuarticLowerBound QuarticTransfer.Terminal8686.dual F) :
...
theorem rung9383
    ...
    (hfull : FullTraceLimits F) (hzero : StableZeroSide F)
    (hweighted : QuarticTransfer.FactoredZeroKernelQuarticLowerBound QuarticTransfer.Terminal9506.dual F) :
