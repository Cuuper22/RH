...
substitute for the trace, zero-side, or one-sided zero-tuple-first kernel bound.
-/
...
theorem rung8657
    ...
    (hweighted : QuarticTransfer.ZeroKernelQuarticLowerBound QuarticTransfer.Terminal8686.dual F) :
...
theorem rung9383
    ...
    (hfull : FullTraceLimits F) (hzero : StableZeroSide F)
    (hweighted : QuarticTransfer.ZeroKernelQuarticLowerBound QuarticTransfer.Terminal9506.dual F) :
