...
substitute for the trace, zero-side, dimension-limit, or target-specific score-convergence premise.
-/
...
theorem rung8657
    ...
    (hscore : QuarticTransfer.QuarticScoreConvergence TrimmedMoment.Terminal8686.dual F) :
...
theorem rung8657_cumulative
  ...
  have hdyadic : ∀ ε > 0, ∃ T₀ : ℝ, ∀ T ≥ T₀,
    ...
    simpa only [Rung8657_statement] using rung8657 hfull hzero hr1a hscore
...
theorem rung8686_cumulative
  ...
  have hdyadic : ∀ ε > 0, ∃ T₀ : ℝ, ∀ T ≥ T₀,
    ...
    simpa only [Rung8686_statement] using rung8686 hfull hzero hr1a hscore
...
theorem rung9383
    ...
    (hfull : FullTraceLimits F) (hzero : StableZeroSide F)
    (hr1a : BlockDimensionLimit F)
    (hscore : QuarticTransfer.QuarticScoreConvergence TrimmedMoment.Terminal9506.dual F) :
...
theorem rung9383_cumulative
  ...
  have hdyadic : ∀ ε > 0, ∃ T₀ : ℝ, ∀ T ≥ T₀,
    ...
    simpa only [Rung9383_statement] using rung9383 hfull hzero hr1a hscore
...
theorem rung9506_cumulative
  ...
  have hdyadic : ∀ ε > 0, ∃ T₀ : ℝ, ∀ T ≥ T₀,
    ...
    simpa only [Rung9506_statement] using rung9506 hfull hzero hr1a hscore
