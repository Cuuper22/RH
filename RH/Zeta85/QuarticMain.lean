...
theorem rung8657
    ...
    (hweighted : QuarticTransfer.UncenteredQuarticTraceLowerBound TrimmedMoment.Terminal8686.dual F) :
...
theorem rung9383
    ...
    (hfull : FullTraceLimits F) (hzero : StableZeroSide F)
    (hweighted : QuarticTransfer.UncenteredQuarticTraceLowerBound TrimmedMoment.Terminal9506.dual F) :
