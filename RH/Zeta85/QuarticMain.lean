...
substitute for the trace, zero-side, or one-sided weighted target-certificate bound.
-/
...
theorem rung8657
    ...
    (hweighted : QuarticTransfer.WeightedQuarticLowerBound QuarticTransfer.Terminal8686.dual F) :
...
theorem rung9383
    ...
    (hfull : FullTraceLimits F) (hzero : StableZeroSide F)
    (hweighted : QuarticTransfer.WeightedQuarticLowerBound QuarticTransfer.Terminal9506.dual F) :
