...
substitute for the trace, zero-side, or weighted target-certificate limit.
-/
...
theorem rung8657
    ...
    (hweighted : QuarticTransfer.WeightedQuarticLimit QuarticTransfer.Terminal8686.dual F) :
...
theorem rung9383
    ...
    (hfull : FullTraceLimits F) (hzero : StableZeroSide F)
    (hweighted : QuarticTransfer.WeightedQuarticLimit QuarticTransfer.Terminal9506.dual F) :
