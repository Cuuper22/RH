...
substitute for the trace, zero-side, or one-sided sum-first trace bound.
-/
...
theorem rung8657
    ...
    (hweighted : QuarticTransfer.QuarticTraceLowerBound QuarticTransfer.Terminal8686.dual F) :
...
theorem rung9383
    ...
    (hfull : FullTraceLimits F) (hzero : StableZeroSide F)
    (hweighted : QuarticTransfer.QuarticTraceLowerBound QuarticTransfer.Terminal9506.dual F) :
